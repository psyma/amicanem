...
namespace amicanem.Service.Auth;
...
public class MauiAuthService : IAuthService
{
    ...
    public MauiAuthService(HttpClient httpClient, IJwtAuthStateProvider jwtAuthStateProvider, ISqliteService sqliteService, IPlatformService platformService)
    {
